...
const tpl = (data = {}, opts = {}) => {
  ...
  <div id="register-info-wrapper" class="register-info-wrapper">
        <form id="register-info-form" onsubmit="return false">
            <label>
                <span>昵称：</span>
                <input id="register-info-nickname" name="nickname" type="text" placeholder="昵称" valid="present noOther" value="${ data.nickname || '' }">
            </label>
            <label>
                <span>电子邮箱：</span>
            ...
            <label>
                <span>&nbsp;</span>
                <input id="register-info-btn" type="submit" value="${opts.btnText}">
            </label>
        </form>
    </div>
`
